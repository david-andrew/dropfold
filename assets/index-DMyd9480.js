...
`)+`
`+d);const M=A+p+o,E=A+d+a,U=Na(r,r.VERTEX_SHADER,M),C=Na(r,r.FRAGMENT_SHADER,E);r.attachShader(x,U),r.attachShader(x,C),e.index0AttributeName!==void 0?r.bindAttribLocation(x,0,e.index0AttributeName):e.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(L){if(i.debug.checkShaderErrors){const q=r.getProgramInfoLog(x).trim(),G=r.getShaderInfoLog(U).trim(),V=r.getShaderInfoLog(C).trim();let Y=!0,k=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(Y=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,U,C);else{const Z=Oa(r,U,"vertex"),W=Oa(r,C,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
